...
static bool operator<(const cellVecinos& a, const cellVecinos& b){
	...
	void Raster::define_intervals(int stop, int &xIntervals, int &yIntervals) {
	...
	map<float,Grid> Raster::define_grids(int rows, int cols, const int &xIntervals, const int &yIntervals, float** biomass, float** friction) {
