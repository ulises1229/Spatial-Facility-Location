...
void Dijkstra::i_Graph(int V, vector<nodeGraph> nodes){
    this->V = V;
    this->nodes = nodes;
    adj = new list<iPair> [V];
}

void Dijkstra::addEdge(int u, int v, float w){//lista de adyacencia de id_nodo u, id_destino v , relation w
    adj[u].push_back(make_pair(w, v));// relacion biomasa/friccion, destino
}

// A utility function used to print the solution
void Dijkstra::printPath(vector<int> parent, int n){
...
bool Dijkstra::isValid(int row, int col){
